...
velocidade, o turbilhão''.\footnote{Gilles Deleuze. {\slsc{Sobre o
...
A singularidade da produção\footnote{A revista {\slsc{Arte em Revista}}:
  no. 5 (São Paulo: \scalebox{0.8}{CEAC}/Kairós, 1981) e n. 8 (São Paulo: \scalebox{0.8}{CEAC}, 1984), fez pioneiramente um inventário e uma mostra dessa vasta produção.}
...
experiência literária.\footnote{Waly Sailormoon. {\slsc{Me segura q'eu
  vou dar um troço}}. Rio de Janeiro: José Álvaro, 1972;

  Torquato Neto. {\slsc{Os últimos dias de paupéria}}. Org. Waly Salomão.
  ...
  Caetano Veloso. {\slsc{Alegria, Alegria}}. Org. Waly Salomão. Rio de
...
outros.\footnote{Heloisa Buarque de Hollanda. {\slsc{26 poetas hoje}}. Rio
...
de literatura.\footnote{Em {\slsc{Arte em Revista"-8}}, encontram"-se
...
instituídos pelas instituições sociais.\footnote{Cf. Celso Favaretto,
  ``A contracultura, entre a curtição e o experimental''. In: \scalebox{0.8}{MODOS}:
...
\emph{Eros e civilização} de Herbert Marcuse, \emph{Vida contra a morte}
...
político.\footnote{Mario Cámara. {\slsc{Corpos pagãos -- usos e figurações
  na cultura brasileira (1960-1980)}}. Trad. Luciana di Leone. Belo
  Horizonte: Ed. \scalebox{0.8}{UFMG}, 2014, p.~9.}
...
vale dizer, dos comportamentos.\footnote{Este texto retoma, sob este
  ...
  60/70''. In: Artur Freitas et al. (org.). {\slsc{Imagem, narrativa e
...
processos de arte em sensações de vida''.\footnote{Hélio Oiticica.
  Catálogo da {\slsc{Whitechapel Experience}}. Londres, 1969, reproduzido
  na coletânea de textos {\slsc{Aspiro ao Grande Labirinto}} (Org.
...
sua tarefa é a de mudar o valor das coisas''.\footnote{Hélio Oiticica,
  ``Experimentar o experimental''. In: {\slsc{Navilouca}}. Torquato Neto e
...
de Paula, \emph{PanAmérica}.\footnote{José Agrippino de Paulo.
  {\slsc{PanAmérica}}. Rio de Janeiro"-\scalebox{0.8}{GB}: Tridente, julho de 1967. Capa de
...
Já em l965 o aparecimento de \emph{Lugar Público},\footnote{José
...
Celso Favaretto, ``A outra América''. In: {\slsc{Jornal de Resenhas}}, n.
  75, 09/06/2001. Reproduzido em: Milton do Nascimento (org.).
...
convicção e violência: transformabilidade.\footnote{Cf. ``60/70: viver a
  arte, inventar a vida''. In: Lisette Lagnado (org.). {\slsc{27ª
...
vida, conforme se entenda as relações de arte e vida.\footnote{Cf. Alain Roger. {\slsc{Nus et paysages -- Essai sur la fonction de l'art}}. Paris: Aubier, 1978.}
...
partilha já dada do sensível	''.\footnote{Jacques Rancière. {\slsc{A partilha do sensível}}. São Paulo: Ed. 34-Exo, 2005, p.~60-61.} Embora às vezes
...
experiência sensível da comunidade''.\footnote{Ibidem, p.~67.}
...
espacial,\footnote{Ibidem, p.~11.} mas é também temporal, já que as mutações
...
sou excluído'', diz Barthes.\footnote{Ibidem, p.~156-157.} Portanto esse espaço em
que a vida se reinventa é, para ambos, o Éden, circunscrição ideal da
comunidade, do viver"-junto.\footnote{Ibidem, p.~95.}
