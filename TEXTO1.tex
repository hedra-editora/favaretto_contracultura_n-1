...
{\large\Formular{\addcontentsline{toc}{chapter}{\footnotesize\Formular A contracultura, entre a curtição e o\\ experimental}
\noindent{}A contracultura, entre a \\curtição e o experimental\footnote{Texto
  publicado anteriormente em {\slsc{\scalebox{0.8}{MODOS} - Revista de História da Arte}}, v.~1,
  n.~3, set/dez 2017.}
}}
\end{vplace}
...
n° 5 (\versal{AI}-5), em 13 de dezembro de 1968, o processo artístico"-cultural, tal como
...
um conjunto de agências, como Instituto Nacional do Cinema (\versal{INC}),
...
país desde a edição do \versal{AI}"-5 e o incremento da censura''.\footnote{``A
  crise da cultura brasileira'', {\slsc{Visão}}, 5 jul. 1971, p.~52.} Na
...
fácil.\footnote{{\slsc{Visão}}, 5 jul. 1971, p.~52.}
\end{quote}
...
subdesenvolvido''.\footnote{``A cultura posta em questão'',
  {\slsc{Visão}}, 24 mar. 1967, p.~47.} O diagnóstico, ao propor uma visão
...
proposições do \versal{CPC} da \versal{UNE}, emblemáticas de um modo de radicalização
...
a edição do \versal{AI}"-5, basta relembrar produções mais significativas surgidas
...
arte"-ação transgressiva, chocante e violenta; depois do \versal{AI}"-5, o desânimo
...
introdutória de {\slsc{Arte em Revista}}, n. 5, São Paulo, Kairós/\scalebox{0.8}{CEAC}, 1981, pp.~3-4.}
...
ficou consagrada no ensaio ``A Geração \versal{AI}"-5'', em que reiterando a
...
instrumentos de alienação.\footnote{12 Luciano Martins, ``A geração \scalebox{0.8}{AI}"-5 (Um ensaio
...
atitude essa espetacularizada nas aparições na \versal{TV}, em shows,
...
daquele momento.\footnote{Arnaldo Jabor, ``Debaixo da terra'', {\slsc{O Pasquim}},
...
{\slsc{Nova consciência}}, Rio de Janeiro, Eldorado, 1973, pp.~46-8.}
\end{quote}
...
revista {\slsc{Vozes}}, ano 66, v.~\scalebox{0.8}{LXVI}, n.~10, 1972, pp.~21-2.}
\end{quote}
...
Oiticica, entrevista a Ivan Cardoso, {\slsc{Folha de S. Paulo, Ilustrada}}, 16 nov. 1985, p.~48; rep. em
César Oiticica Filho e Ingrid Vieira (org.),  {\slsc{Encontros -- Hélio Oiticica}}, Rio de Janeiro,
...
para a reprodutividade.\footnote{Jean"-François Lyotard, ``Esquisse
  d'une économique de l'hipperréalisme'', {\slsc{Dispositifs
...
problema''.\footnote{Hélio Oiticica, ``Brasil diarréia'', Ferreira Gullar (org.), {\slsc{Arte brasileira
hoje}}, Rio de Janeiro, Paz e Terra, 1973, p.~150.} A entronização do eu, a ênfase na produção de
...
do \emph{ser artista}''.\footnote{Jean Galard, ``L'art sans \oe uvre'', Jean Galard et al. (org.),
  {\slsc{L'\oe uvre d'art totale}}, Paris, Gallimard/Musée du Louvre, 2003,
  pp.~168-9.}
...
reinventa, circunscrição ideal da comunidade, do viver"-junto.\footnote{Roland
  Barthes, {\slsc{Como viver junto}}, São Paulo, Martins Fontes, 2003, pp.~11 e 157.}
...
Figueiredo; Lygia Pape; Waly Salomão (org.), {\slsc{Aspiro ao grande
...
artística.\footnote{Henri"-Pierre Jeudy, {\slsc{O corpo como objeto de arte}}, São Paulo,
...
contrário da ``tomada de consciência''.\footnote{Peter Pál Pelbart, {\slsc{Vida Capital: ensaio de
...
movimento, a velocidade, o turbilhão''.\footnote{Gilles Deleuze, {\slsc{Sobre o
  teatro: um manifesto a menos}}, Fátima Saadi (trad.), Rio de Janeiro,
...
A singularidade da produção\footnote{A revista {\slsc{Arte em Revista}} n.
5 (São Paulo, \scalebox{0.8}{CEAC}/Kairós, 1981) e n. 8 (São Paulo, \scalebox{0.8}{CEAC}, 1984), fez
...
indicam uma nova e inventiva experiência literária.\footnote{Waly Sailormoon, {\slsc{Me segura q'eu
  vou dar um troço}}, Rio de Janeiro, José Álvaro, 1972;

  Torquato Neto, {\slsc{Os últimos dias de paupéria}}, Waly Salomão (org.),
  Rio de Janeiro, Ground, 1973; 2ª ed. São Paulo, Max Limonad, 1983;

  Gramiro de Matos, {\slsc{Urubu"-Rei}}, Rio de Janeiro, Gernasa, 1972;

  \_\_\_\_\_\_\_\_. {\slsc{Os morcegos estão comendo os mamãos maduros}},
  Rio de Janeiro, Eldorado, 1973;

  José Simão, {\slsc{Folias brejeiras}}, edição do autor, 1975;

  Caetano Veloso, {\slsc{Alegria, Alegria}}, Waly Salomão (org.), Rio de
  Janeiro, Pedra Q Ronca, s/d;

  Jorge Mautner, {\slsc{Fragmentos de sabonete}}, Rio de Janeiro, Ground,
  1976;

  Paulo Leminski, {\slsc{Catatau}}, Curitiba, edição do autor, 1975.}
...
enunciação da associação, para com uns e outros.\footnote{\textls[-15]{Heloisa Buarque de Hollanda (org.),
{\slsc{26 poetas hoje}}, Rio de Janeiro, Editorial Labor do Brasil, 1976 (Coleção Bolso).}} A compreensão do que
...
literários.\footnote{\textls[-15]{Em {\slsc{Arte em Revista"-8}}, encontram"-se
...
{\large\Formular{\addcontentsline{toc}{chapter}{\footnotesize\Formular 60/70: Da participação ao comportamental}
\noindent{}60/70: Da participação\\ ao comportamental\footnote{Revista
  {\slsc{Literatura e Sociedade}}, n. 29, jan.-jun. 2019.}
}}
\end{vplace}
...
instituídos pelas instituições sociais.\footnote{Cf. Celso Favaretto,
  ``A contracultura, entre a curtição e o experimental'', {\slsc{\scalebox{0.8}{MODOS} --
...
político.\footnote{Mario Cámara, {\slsc{Corpos pagãos -- usos e
figurações na cultura brasileira (1960-1980)}}, Belo Horizonte, Ed.
\scalebox{0.8}{UFMG}, 2014, p.~9.}
...
{\slsc{Imagem, narrativa e subversão}}, São Paulo, Intermeios, 2016.}
...
processos de arte em sensações de vida''.\footnote{Hélio Oiticica,
  ...
  Luciano Figueiredo, Lygia Pape, Waly Salomão (org.), {\slsc{Aspiro ao Grande Labirinto}},
...
{\slsc{Navilouca}}, Rio de Janeiro, Edições Gernasa, 1974.} Oiticica
...
Paula, \emph{PanAmérica}.\footnote{José Agrippino de Paula,
  {\slsc{PanAmérica}}, Rio de Janeiro"-\scalebox{0.8}{GB}, Tridente, jul. 1967. Capa de
...
transformação social.\footnote{Antonio Callado, {\slsc{Quarup}}, Rio de
  Janeiro, Civilização Brasileira, 1968.}

Já em 1965, a publicação de \emph{Lugar público},\footnote{José
  Agrippino de Paula, {\slsc{Lugar público}}, Rio de Janeiro, Civilização
...
cultura''.\footnote{Evelina Hoisel, {\slsc{Supercaos, os estilhaços da
...
emblemas.\footnote{Cf. Celso Favaretto, ``A outra América'', {\slsc{Jornal de Resenhas}}, n.
75, 9 jun. 2001. Reproduzido em: Milton do Nascimento (org.),
  {\slsc{Jornal de Resenhas}}, v.~\scalebox{0.8}{III}, São Paulo, Discurso Editorial, 2002,
  pp.~2.155-7.}
...
vida'', Lisette Lagnado (org.), {\slsc{27ª Bienal de São Paulo: Seminários}}, Rio de Janeiro, Cobogó, 2008, pp.~240-9.}
...
\begin{vplace}[0.25]
\thispagestyle{empty}
{\large\Formular{\addcontentsline{toc}{chapter}{\footnotesize\Formular 60/70: Viver a arte, inventar a vida}
\noindent{}60/70: Viver a arte,\\ inventar a vida\footnote{Catálogo da
  {\slsc{27ª Bienal de São Paulo: Seminários, 2006}}, Lisette Lagnado (org.), Rio de Janeiro, Cobogó, 2008, p.~240-9.}
}}
\end{vplace}
...
Roger, {\slsc{Nus et paysages -- Essai sur la fonction de l'art}}, Paris, Aubier, 1978.}
...
Rancière, {\slsc{A partilha do sensível}}, São Paulo, Ed. 34-Exo, 2005, pp.~60-1.} Embora às vezes
...
(org.), {\slsc{Aspiro ao grande labirinto}}, seleção de textos de Hélio
...
\begin{quote} %Isso é quote mesmo? Está sem nenhuma indicação de autoria
