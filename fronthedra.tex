...
%\vspace*{-80pt}
\begin{changemargin}{-55pt}{-60pt}
{\large\Formular{

\mbox{\textbf{Celso Favaretto} \hspace{0.4cm}\textbf{Celso Favaretto} \hspace{0.4cm}\textbf{Celso Favaretto}}\vspace{0.5pt}
\mbox{A contracultura, \hspace{0.5cm}A contracultura, \hspace{0.5cm}A contracultura,}\vspace{0.5pt}
\mbox{entre a curtição \hspace{0.5cm}entre a curtição \hspace{0.5cm}entre a curtição}\vspace{0.5pt}
\mbox{e o experimental \hspace{0.34cm}e o experimental \hspace{0.34cm}e o experimental}
}}
\end{changemargin}
%% Front ---------------------------------------------------------
% Titulo
