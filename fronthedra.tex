...
\hspace*{-65pt}
\mbox{\noindent\rlap{\enspace C C C C C}{C C C C C C}}
\hspace*{-65pt}\vspace*{-20pt}{
\mbox{\rlap{\noindent\enspace C C C l C}{C C C C C C}}}
\hspace*{-65pt}
\mbox{\noindent\rlap{\enspace C C C C C}{C C C C C C}}
\hspace*{-65pt}
\mbox{\noindent\rlap{\enspace C C C C C}{C C C C C C}}
...
%% Front ---------------------------------------------------------
% Titulo
{\fakereceipt{\large{N-1 edições \hspace{2.6cm} coleção

\vspace*{-4mm}

\& hedra \hspace{4cm} Lampejos}}}
\vspace{11.25mm}
